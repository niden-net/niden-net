...
I am happy to announce that one of my domains has already gone through the merge process. The domain is [BeautyAndTheGeek.IT](https://wwww.beautyandthegeek.it) which is a Google Apps Premier edition. My other domains that are hosted in Google Apps have not transitioned yet and I suspect that Google is first merging Premium accounts, then Educational, Government and it will finish up with the Standard edition of Google Apps, which kind of makes sense (paid customers first!).
