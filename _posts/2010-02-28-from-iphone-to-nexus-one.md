...
Overall I am really glad that I made the switch. The screen and camera are amazing, the phone is really responsive and apart from a couple of times that I didn't know how to do something and I had to Google it, I am using it as if I had it for a long time. I have **no restrictions**, I don't have to jailbreak the device so that I can get some applications that Apple deemed that they *ruin the user experience* (according to [their reply to the FCC](https://archive.org/details/perma_cc_DEJ5-75VB) regarding Google Voice), my data is synchronized with the cloud and [I can get it out of there at will](https://dataliberation.org/). I can even develop my own application and install it if I wish to. This is something that the iPhone does not provide and notable is the fact that I had to retype all my store cards that I used Cardscan for in the Key Card scanner and there is no way for me to get the data that FuelGauge has stored in it and potentially transfer it to aCar.
